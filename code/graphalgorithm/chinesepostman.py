...
class ChinesePostman():
    """class that implements the chinese postman algorithm"""
    def __init__(self, graph):
        self.graph = graph

    def create_odd_graph(self, graph):
        """
    ...
    def add_shadow_nodes(self, graph, odd, matching):
        """
    ...
    def eulerize(self):
        ...
        odd = self.create_odd_graph(self.graph)
        ...
        eulerian_graph = self.add_shadow_nodes(self.graph, odd, matching)
